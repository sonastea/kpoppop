...
const ContactUs = () => {
  return (
    <div className="overflow-hidden shadow-md md:w-full md:h-[calc(100vh-80px)] grid grid-rows-2 md:flex md:items-center">
      <div className="py-2 text-thrice md:bg-white md:flex-shrink-0 md:mx-12">
      ...
      <div className="items-center w-full h-full md:text-gray-800 md:text-2xl font-semi-bold md:font-semibold md:flex md:bg-gradient-to-r md:from-once-400 md:to-ponce-400">
        <div className="py-2 text-center md:flex-1">
          <a
            className="whitespace-pre underline md:no-underline md:px-2 md:align-baseline md:hover:text-thrice"
